...
const en: Dict = {
  ...
  'dash.onFire': '🔥 ON FIRE! 1.5x Active',
  'dash.comboToast': '🔥 3-in-a-row Speed Combo! +50% Bonus Score!',
  ...
  'station.checking': 'Verifying…',
  'station.queued': 'Offline — we’ll verify your code automatically when the connection is back.',
  'station.retrying': 'Connection restored — verifying your code…',
  ...
  'station.locationRequired': 'Turn on location to check in here — this station must verify you are nearby.',
  'station.tooFar': 'You are {distance}m away — you must be within {radius}m of the station.',
  'station.distanceAway': '{dist} away',
...
const he: Dict = {
  ...
  'dash.pts': 'נק׳',
  'dash.penalty': 'קנס',
  'dash.onFire': '🔥 ברצף מטורף! פי 1.5 ניקוד',
  'dash.comboToast': '🔥 קומבו מהירות! 3 תחנות ברצף! 50%+ בונוס ניקוד!',
  ...
  'station.checking': 'מאמת…',
  'station.queued': 'לא מקוונים — נאמת את הקוד אוטומטית כשהחיבור יחזור.',
  'station.retrying': 'החיבור חזר — מאמת את הקוד…',
  ...
  'station.locationRequired': 'הפעילו מיקום כדי להירשם בתחנה — התחנה חייבת לוודא שאתם נמצאים בקרבת מקום.',
  'station.tooFar': 'אתם במרחק {distance} מ׳ — עליכם להיות במרחק של עד {radius} מ׳ מהתחנה.',
  'station.distanceAway': '{dist} ממך',
