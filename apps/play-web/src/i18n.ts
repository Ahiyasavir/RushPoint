...
const HE = {
  ...
  challenge: {
    badge: 'אתגר חברים',
    tagline: 'תפתרו את זה ב-30 שניות 😏',
    ...
    ctaBuild: '✨ בנו הרפתקה משלכם',
    shareBtn: '😏 אתגרו חבר',
    shareText: ({ game }: { game: string }) => `מצליחים לפתור את זה? אתגר מתוך "${game}" ב-RushPoint`,
  },
  task: {
...
const EN: typeof HE = {
  ...
  challenge: {
    ...
    ctaBuild: '✨ Build your own adventure',
