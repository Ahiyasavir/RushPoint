...
const HE = {
  ...
  join: {
    ...
    oneDeviceNote: 'נציג אחד מכל קבוצה מזין את הקוד.',
  ...
  task: {
    ...
    verify: 'אמת',
    scannerOpeningA: 'פותחים את המצלמה…',
    scannerOpeningB: 'מכינים את סורק הקודים…',
    ...
    rejectedNoReason: 'המנחה ביקש שתנסו שוב.',
    rejectedTryAgain: 'נסו שוב ושלחו משהו אחר',
    ...
    audioUnsupported: 'הדפדפן הזה לא תומך בהקלטה ישירה. הקליטו עם אפליקציית ההקלטה של הטלפון ובחרו את הקובץ.',
    ...
    videoKeepRecording: ({ sec }: { sec: number }) => `המשיכו לצלם, עוד ${sec} שניות`,
    videoMinHint: ({ sec }: { sec: number }) => `הסרטון צריך להיות באורך ${sec} שניות לפחות.`,
    videoMaxHint: ({ sec }: { sec: number }) => `אפשר לצלם עד ${sec} שניות.`,
    videoRangeHint: ({ min, max }: { min: number; max: number }) => `צלמו סרטון באורך ${min} עד ${max} שניות.`,
    working: 'עובד…',
    takePhoto: 'צלמו תמונה',
    retakePhoto: 'צלמו שוב',
    photoSaveRetry: 'לא הצלחנו לשמור את התמונה. התמונה נשמרה אצלכם, נסו לשלוח שוב.',
  ...
  final: {
    ...
    finalizingRanks: 'מסדרים את טבלת הדירוג…',
  ...
  staff: {
    ...
    // ── Field-ops (change: staff-console-field-ops) ──
    searchTeams: 'חיפוש קבוצה',
    noTeamsMatch: 'אין קבוצה בשם הזה.',
    customAmount: 'סכום אחר',
    customAmountPlaceholder: 'מספר נקודות',
    customAmountApply: 'אישור',
    customAmountCancel: 'ביטול',
    reasonLabel: 'סיבה',
    ...
    holdTeam: 'עצירת הקבוצה',
    resumeTeam: 'החזרת הקבוצה למשחק',
    heldBadge: 'עצורה',
    heldSince: 'עצורה מאז',
    holdReasonPrompt: 'למה אתם עוצרים את הקבוצה? (רשות)',
    holdFailed: 'עצירת הקבוצה נכשלה',
    resumeFailed: 'החזרת הקבוצה נכשלה',
    clearOutOfBounds: 'שחרור מחוץ לתחום',
    outOfBoundsBadge: 'מחוץ לתחום',
    clearOutOfBoundsFailed: 'השחרור נכשל',
    skipTask: 'דילוג על המשימה',
    skipTaskConfirm: 'לדלג על המשימה הנוכחית של הקבוצה?',
    skipTaskFailed: 'הדילוג נכשל',
    forceAssign: 'שליחה למשימה',
    forceAssignPick: 'בחרו משימה לשליחת הקבוצה',
    forceAssignOverride: 'עקיפת נעילה',
    forceAssignOverrideWarn: 'המשימה נעולה או סגורה. שליחה בכל זאת תירשם ביומן.',
    forceAssignFailed: 'שליחת הקבוצה נכשלה',
    forceAssignNoTasks: 'אין משימות פנויות בשלב הנוכחי של הקבוצה.',
    teamMap: 'מפת הקבוצות',
    teamMapEmpty: 'אף קבוצה עדיין לא שידרה מיקום.',
    teamMapOpen: 'ניווט לקבוצה',
    channelTitle: 'קשר עם המנהל',
    channelEmpty: 'אין הודעות עדיין. כתבו למנהל האירוע.',
    channelPlaceholder: 'הודעה למנהל',
    channelSend: 'שליחה',
    channelAdmin: 'מנהל האירוע',
    channelFailed: 'ההודעה לא נשלחה. נסו שוב.',
    announcement: 'הודעה',
    msgEn: 'הודעה (אנגלית)',
  ...
  play: {
    ...
    // Staff hold (change: staff-console-field-ops). Says WHO stopped them and that
    // the clock is not running — a team that thinks it is losing time will keep
    // trying to submit, which is exactly what the hold refuses.
    teamHeld: 'הצוות עצר אתכם לרגע. השעון מושהה ואפשר להמתין בשקט.',
    forceAssigned: 'הצוות שלח אתכם למשימה חדשה.',
  },
  devices: {
  ...
  board: {
    ...
    loadingA: 'טוענים את טבלת הדירוג…',
    loadingB: 'מביאים את התוצאות העדכניות…',
  ...
  recap: {
    ...
    loadingA: 'אוספים את רגעי המשחק…',
    loadingB: 'מסדרים את הסיכום…',
    enterCode: 'הזנת קוד',
...
const EN: typeof HE = {
  ...
  join: {
    ...
    how2Label: 'Race', how2Sub: 'Get routed to missions',
  ...
  task: {
    ...
    blockedClearBody: 'The host released you. Tap to get your next mission.',
    ...
    lockedOnlyTitle: 'Your next mission is still locked',
    lockedOnlyBody: 'More missions open up as you complete others.',
    ...
    submitExpired: 'This mission has closed.',
    ...
    notAvailableYet: 'This mission is not available yet.',
    ...
    taskExpiredNotice: 'This mission closed, moving on…',
    mapAppears: 'Map will appear once your mission has a location.',
    photoPreview: 'preview',
    yourTask: 'Your mission',
    routedTask: 'Your mission',
    ...
    clockPaused: 'The clock is stopped on this mission. Take your time, the minutes here do not count toward the standings.',
    sealedTitle: 'Mystery destination',
    sealedHelp: 'The map marks a search area, not the spot. The mission itself opens once you reach it.',
    checkArrival: 'We got here',
    notThereYet: 'Not there yet. Keep following the clue.',
    arrivalUnlocked: 'You made it! The mission is open.',
    arrivalNeedsOnline: 'No connection right now. The mission opens the moment you are back online.',
    verify: 'Verify',
    scannerOpeningA: 'Opening the camera…',
    scannerOpeningB: 'Getting the scanner ready…',
    ...
    rejectedNoReason: 'The host asked for another try.',
    rejectedTryAgain: 'Try again and send something else',
    ...
    audioUnsupported: 'This browser cannot record directly. Record with your phone app, then pick the file.',
    ...
    videoKeepRecording: ({ sec }: { sec: number }) => `Keep filming, ${sec}s more`,
    videoMinHint: ({ sec }: { sec: number }) => `The clip needs to be at least ${sec} seconds long.`,
    videoMaxHint: ({ sec }: { sec: number }) => `You can film up to ${sec} seconds.`,
    videoRangeHint: ({ min, max }: { min: number; max: number }) => `Film a clip ${min} to ${max} seconds long.`,
    working: 'Working…',
    takePhoto: 'Take Photo',
    retakePhoto: 'Retake',
    photoSaveRetry: 'That photo could not be saved. Your photo is still here, try sending it again.',
    ...
    hintConfirm: ({ cost }: { cost: number }) => `Reveal a hint for this mission? It costs ${cost} points.`,
    hintConfirmBtn: 'Reveal hint',
    attemptConfirm: ({ remaining }: { remaining: number }) =>
      `This mission has a limited number of tries. A wrong answer uses one up, and you have up to ${remaining} left. Submit the choice you picked?`,
  ...
  final: {
    ...
    finalizingRanks: 'Lining up the standings…',
  ...
  staff: {
    ...
    noTeamsMatch: 'No team by that name.',
    customAmount: 'Custom amount',
    customAmountPlaceholder: 'Points',
    customAmountApply: 'Apply',
    customAmountCancel: 'Cancel',
    reasonLabel: 'Reason',
    ...
    heldBadge: 'On hold',
    heldSince: 'On hold since',
    holdReasonPrompt: 'Why are you holding this team? (optional)',
    holdFailed: 'Could not hold the team',
    resumeFailed: 'Could not resume the team',
    clearOutOfBounds: 'Clear out of bounds',
    outOfBoundsBadge: 'Out of bounds',
    clearOutOfBoundsFailed: 'Could not clear it',
    skipTask: 'Skip mission',
    skipTaskConfirm: 'Skip this team’s current mission?',
    skipTaskFailed: 'Could not skip the mission',
    forceAssign: 'Send to mission',
    forceAssignPick: 'Pick a mission to send this team to',
    forceAssignOverride: 'Override lock',
    forceAssignOverrideWarn: 'This mission is locked or closed. Sending anyway is recorded in the log.',
    forceAssignFailed: 'Could not send the team',
    forceAssignNoTasks: 'No available missions in this team’s current stage.',
    teamMap: 'Team map',
    teamMapEmpty: 'No team has reported a location yet.',
    teamMapOpen: 'Navigate to team',
    channelTitle: 'Admin channel',
    channelEmpty: 'No messages yet. Write to the event admin.',
    channelPlaceholder: 'Message the admin',
    channelSend: 'Send',
    channelAdmin: 'Event admin',
    channelFailed: 'Message not sent. Try again.',
  ...
  play: {
    ...
    powerUpDoubleToast: '⚡ Power up! Next mission 2x',
    ...
    teamHeld: 'Staff paused your team for a moment. Your clock is stopped, so you can wait calmly.',
    forceAssigned: 'Staff sent you to a new mission.',
  },
  devices: {
  ...
  survey: {
    ...
    qContent: 'How interesting were the missions and content?',
    ...
    issueTaskUnclear: 'Unclear mission',
  ...
  board: {
    ...
    loadingA: 'Loading the leaderboard…',
    loadingB: 'Fetching the latest scores…',
  ...
  recap: {
    ...
    loadingA: 'Gathering the highlights…',
    loadingB: 'Putting the recap together…',
    enterCode: 'Enter a code',
