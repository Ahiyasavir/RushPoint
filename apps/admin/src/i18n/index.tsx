...
const en: Dict = {
  ...
  'teams.skipDone': 'Skipped — team advanced to the next task.',
  ...
  'leaderboard.frozenBody': 'Leaderboard is frozen',
...
const he: Dict = {
  ...
  'teams.skipDone': 'דולג — הקבוצה התקדמה למשימה הבאה.',
  ...
  'leaderboard.frozenBody': 'טבלת המובילים מוקפאת',
  'leaderboard.noFinishers': 'אף קבוצה לא סיימה עדיין',
