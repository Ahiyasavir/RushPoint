...
const HE = {
  ...
  builder: {
    ...
    estimateHelp: 'זו ההערכה שהשחקנים והניקוד מודדים מולה. השעון של המשימה מתחיל ברגע שהיא נשלחת לקבוצה, ולכן ההערכה כוללת גם את ההליכה לנקודה וגם את הפעולה עצמה. אפשר לשנות אותה בשדה "דקות משוערות".',
    maxTeams: 'מקס׳ קבוצות',
...
const EN: typeof HE = {
  ...
  builder: {
    ...
    estimateHelp: 'This is the estimate players and scoring are measured against. A task\'s clock starts the moment it is handed to a team, so the estimate covers both the walk to the spot and the activity there. Change it in the "Estimated minutes" field.',
    maxTeams: 'Max teams',
