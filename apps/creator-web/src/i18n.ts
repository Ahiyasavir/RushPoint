...
const EN: typeof HE = {
  ...
  builder: {
    ...
    locAnywhereDesc: 'A fully digital task with no map pin. Players can do it from anywhere.',
    ...
    locRadiusHelp: 'How near the spot a player has to be for the task to open. The default (40m) is right almost every time.',
    locRadiusPresetTight: 'Precise (4m)',
    locRadiusPresetDefault: 'Normal (40m)',
    locSkipGps: 'Skip the GPS check',
    locSkipGpsDesc: 'Opens the task without verifying players really arrived. The pin stays on the map and the walk still counts. Good for indoor spots where GPS is unreliable.',
    metersShort: 'm',
    ...
    estimateHelp: 'Covers the walk to the spot plus the task itself.',
    maxTeams: 'Max teams',
