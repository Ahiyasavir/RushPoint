...
## Purpose
TBD - created by archiving change builder-mission-editor-route. Update Purpose after archive.
## Requirements
...
### Requirement: Back dismisses the editor rather than leaving the Builder
 While the mission editor is open, the platform back affordance (the phone's back gesture or button, and the browser's back control) SHALL close the editor and return the creator to the Builder with
